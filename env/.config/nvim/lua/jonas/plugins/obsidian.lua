...
vim.api.nvim_set_keymap(
	...
	{ noremap = true, silent = true, desc = "Create obsidian note (quote template)" }
)
vim.api.nvim_set_keymap(
	"n",
	"<leader>oc",
	":lua create_obsidian_note('code_note')<CR>",
	{ noremap = true, silent = true, desc = "Create obsidian note (code template)" }
)
vim.api.nvim_set_keymap(
	"n",
	"<leader>ot",
	":lua create_obsidian_note('tool_note')<CR>",
	{ noremap = true, silent = true, desc = "Create obsidian note (tool template)" }
)
vim.api.nvim_set_keymap(
	"n",
	"<leader>og",
	":lua create_obsidian_note('guide_note')<CR>",
	{ noremap = true, silent = true, desc = "Create obsidian note (guide template)" }
)
vim.api.nvim_set_keymap(
	"n",
	"<leader>ob",
	":lua create_obsidian_note('blank_note')<CR>",
	{ noremap = true, silent = true, desc = "Create obsidian note (blank template)" }
)
